...
function openPopup(url) {
    ...
    // Load the content from the provided URL into the iframe
    popupIframe.src = url;
...
document.getElementById("wish6").addEventListener("click", function () {
    openPopup("wish6.html"); // Replace with the actual URL you want to load
});

document.getElementById("wish7").addEventListener("click", function () {
    openPopup("wish7.html"); // Replace with the actual URL you want to load
});

document.getElementById("wish8").addEventListener("click", function () {
    openPopup("wish8.html"); // Replace with the actual URL you want to load
});
